...
namespace UCEP.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult ExportCSV(PatientModel pt)
        {
            ...
            Session["FsDrugTemplateList"] = result;
        ...
        {
            var dataList = Session["FsDrugTemplateList"] as List<FsDrugTemplate>;
            ...
            return File(new UTF8Encoding().GetBytes(sb.ToString()), "text/csv", $"{Session["hn"]}.csv");
        }
    }
};
